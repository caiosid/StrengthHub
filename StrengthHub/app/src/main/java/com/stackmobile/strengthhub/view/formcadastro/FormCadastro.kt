package com.stackmobile.strengthhub.view.formcadastro
...
import com.stackmobile.strengthhub.databinding.ActivityFormCadastroBinding
                ...
                auth.createUserWithEmailAndPassword(email,senha).addOnCompleteListener {cadastro ->
                  if(cadastro.isSuccessful){
                    ...
                    val mensagemErro = when(exception){
                        ...
                        is FirebaseAuthUserCollisionException -> "Esta conta já foi cadrastrada!"
